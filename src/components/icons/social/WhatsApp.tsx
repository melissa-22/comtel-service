const WhatsApp = (props: { color: string, width: number, height: number, className: string }) => {
    return (
        <svg className={`${props.className} hover:cursor-pointer duration-500`} width={props.width} height={props.height} fill={props.color} viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                <path
